...
function app_config(?string $key = null): mixed
{
    ...
    if (!is_array($configuration)) {
        ...
        $configuration = [
            ...
            'gemini_mock_budget_bypass' => app_environment_bool('GEMINI_MOCK_BUDGET_BYPASS', false),
            ...
            'batch_rate_limit_backoff_seconds' => app_environment_int('CMS_BATCH_RATE_LIMIT_BACKOFF_SECONDS', 5, 5, 3600),
            ...
            'source_image_query_budget_per_slot' => app_environment_int('CMS_SOURCE_IMAGE_QUERY_BUDGET_PER_SLOT', 4, 1, 40),
