...
<body class="is-preload admin-page admin-page-<?php echo escape_html($active); ?>">
    <div id="wrapper" class="fade-in">
        ...
        if ($active === 'studio' && $configIssues !== []):
        ?>
            <details class="admin-config-issues">
                <summary>Uwagi konfiguracji (<?php echo count($configIssues); ?>)</summary>
...
function admin_page_close(): void
{
    ...
    <script src="../assets/js/admin-content-studio.js?v=bueno-release-20260731a"></script>
</body>
</html>
    <?php
}
