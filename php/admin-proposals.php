        ...
        try {
            ...
            if ($action === 'regenerate') {
                ...
                if ($scope === 'images') {
                    ...
                    header('Location: admin-proposals.php?draft=' . $newDraftId . '&generated=1', true, 303);
                    exit;
                }
        ...
        <?php if ($selected && $post): ?>
            ...
            <section class="proposal-images"><h2>Obrazy i licencje</h2><div class="proposal-image-grid">
                <?php foreach ($images as $image): ?><article class="proposal-image-card">
                    <?php $imageStatus = (string) $image['status']; $imageVerified = $imageStatus === 'downloaded' && article_image_license_is_auto_safe((string) $image['license']); ?>
