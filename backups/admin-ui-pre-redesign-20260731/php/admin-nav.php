...
<nav id="nav" class="admin-nav" aria-label="Panel administratora">
    ...
    <ul class="links admin-nav-links">
        <li><a href="admin-content-studio.php"<?php echo admin_nav_class('studio', $adminActive); ?>>Studio</a></li>
        ...
        <li><a href="admin-proposals.php"<?php echo admin_nav_class('proposals', $adminActive); ?>>Gotowe propozycje</a></li>
