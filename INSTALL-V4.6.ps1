...
$backup = Join-Path $ProjectRoot "_agent-backups\pre-v4.6-$stamp"

Write-Host "Mamona V4.6 Tri-Tier Parallel Stable" -ForegroundColor Cyan
...
$backup | Out-File -Encoding utf8 (Join-Path $ProjectRoot ".kilo\V4.6-LAST-BACKUP.txt")

Write-Host "" 
Write-Host "V4.6 installed." -ForegroundColor Green
Write-Host "CURRENT_WORK, checkpoints, research and source code were NOT overwritten."
Write-Host "Next:"
Write-Host "1. powershell -ExecutionPolicy Bypass -File .\VERIFY-V4.6.ps1 -ProjectRoot `"$ProjectRoot`""
...
Write-Host "5. Paste PROMPT_START_MAMONA_V4.6.md"
